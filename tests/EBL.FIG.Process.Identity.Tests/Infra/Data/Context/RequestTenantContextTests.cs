namespace EBL.FIG.Process.Identity.Tests.Infra.Data.Context;
...
public class RequestTenantContextTests
{
    ...
    {
        var sut = new EBL.FIG.Process.Identity.Infra.Data.Context.RequestTenantContext();
    ...
    public void RequestTenantContext_DeveImplementarInterface()
    {
        ...
        Assert.IsAssignableFrom<EBL.FIG.Process.Identity.Domain.Interfaces.Base.IRequestTenantContext>(sut);
    }
