...
namespace EBL.FIG.Process.Identity.Tests.Infra.Data.Repository;
...
public class UserRoleDataRepositoryTests
{
    ...
    private static void SeedRelatedEntities(EBL.FIG.Process.Identity.Infra.Data.Context.IdentityDbContext context)
    {
