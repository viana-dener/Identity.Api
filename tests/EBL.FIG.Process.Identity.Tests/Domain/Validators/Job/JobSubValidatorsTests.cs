...
namespace EBL.FIG.Process.Identity.Tests.Domain.Validators.Job;
...
public class JobDefinitionCreateValidatorTests
{
    ...
    private const string ValidType = "EBL.FIG.Process.Identity.Infra.Job.Jobs.Cleanup.CleanupExpiredJwtKeysJob";
