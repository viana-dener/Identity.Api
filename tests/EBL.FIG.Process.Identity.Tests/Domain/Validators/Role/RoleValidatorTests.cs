...
namespace EBL.FIG.Process.Identity.Tests.Domain.Validators.Role;

public class RoleValidatorTests
{
    private readonly Mock<ILocalizationService> _localizationMock = new();

    private RoleValidator CreateSut() => new(_localizationMock.Object);

    private static RoleEntity BuildRole(int id = 1, int tenantId = 1, int appId = 2, string name = "Role Test", string description = "Descrição", bool isActive = true, bool isDeleted = false)
    {
        var entity = new RoleEntity(tenantId, appId, name, description, 10);
    ...
    {
        var entity = BuildRole(tenantId: 0);
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(name: new string('A', 101));
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(description: "");
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(description: new string('D', 256));
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(isDeleted: true);
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(isActive: false);
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(isActive: false, isDeleted: true);
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(id: 0, isActive: false);
        var sut = CreateSut();
    ...
    {
        var entity = BuildRole(isActive: true);
        var sut = CreateSut();
