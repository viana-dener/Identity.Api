...
namespace EBL.FIG.Process.Identity.Domain.Interfaces.Base;
...
public interface ICurrentUserService
{
    ...
    /// </summary>
    /// <returns>An integer representing the application's unique identifier.</returns>
    int GetAppId();
    ...
    /// <summary>
    /// Obtém o identificador do usuário para usar em campos de auditoria (AddedBy/ModifiedBy).
