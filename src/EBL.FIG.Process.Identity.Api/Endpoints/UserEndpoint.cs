...
public static class UserEndpoint
{
    public static void MapUserEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        groupV1.MapPatch("/{id}/password", async ([FromRoute] int id, [FromBody] UpdateSecretRequest request, [FromServices] IUserAppService appService, [FromServices] INotify notify, CancellationToken ct) =>
        {
